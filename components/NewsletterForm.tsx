  ...
  if (status === "success") {
    return (
      <div className="text-center py-10">
        ...
        <h3 className="font-display text-xl text-[var(--ink)] mb-2">You&apos;re in!</h3>
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 border border-[var(--line)] text-sm focus:outline-none focus:border-[#c70000]"
          />
        </div>
        <div>
          <label className="block text-sm font-medium text-[var(--ink)] mb-1">
      ...
      <div>
        ...
        <select
          ...
          className="w-full px-4 py-3 border border-[var(--line)] text-sm focus:outline-none focus:border-[#c70000] bg-[var(--paper)]"
        >
      ...
      <button
        ...
        className="w-full bg-[var(--red)] text-white font-bold py-4 text-sm hover:bg-[var(--red-deep)] transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
      >
