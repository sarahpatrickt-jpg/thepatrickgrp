      ...
      <section className="py-6 px-4 sm:px-6 bg-[#1a1a1a] border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center text-sm text-white/60">
            <div>
              <span className="text-white font-semibold">12+</span> Programs
              Checked
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                desc: "We check your profile against 12+ state, county, and federal programs and show you which ones you likely qualify for.",
              },
              {
                n: "03",
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 text-sm mt-3 max-w-xl mx-auto">
              Our tool screens against these state, county, and federal programs.
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              { name: "National Faith", amount: "Up to $13,999", type: "Wayne County" },
              ...
              { name: "HomeReady", amount: "3% down", type: "Moderate Income" },
            ].map((p) => (
              <div
                key={p.name}
