...
export const comparisons: CityComparison[] = [
...

  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "That depends entirely on your priorities. If Troy School District and the Oakland County address matter to your family, the premium is justified by those specific factors. If not, Sterling Heights offers genuine value with comparable housing stock.",
      },
    ],
  },
...

  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Both are seeing increased buyer interest from families priced out of southern Oakland County. Lake Orion's lower price floor makes it more accessible to first-time buyers. Clarkston attracts buyers specifically seeking space and privacy.",
      },
      {
...

  {
    ...
    faqs: [
      ...
      {
        q: "Which is better for families?",
        a: "Both are strong family markets with different appeals. Northville offers community events, a walkable downtown, and a tight-knit feel. Novi offers newer homes, modern amenities, and strong parks and recreation programming.",
      },
    ],
  },
];
